...
#pragma warning restore CA1034 // Nested types should not be visible
        ...
        public void Info(string category, string debugMessage, [CallerFilePath] string file = null, [CallerMemberName] string member = null, [CallerLineNumber] int line = 0)
            => WriteEvent(1, category ?? "", debugMessage ?? "", file ?? "", member ?? "", line);

        [T.Event(2, Level = EventLevel.Warning)]
        public void Warning(string category, string debugMessage, [CallerFilePath] string file = null, [CallerMemberName] string member = null, [CallerLineNumber] int line = 0)
            => WriteEvent(2, category ?? "", debugMessage ?? "", file ?? "", member ?? "", line);

        [T.Event(3, Level = EventLevel.Error)]
        public void Error(string category, string debugMessage, [CallerFilePath] string file = null, [CallerMemberName] string member = null, [CallerLineNumber] int line = 0)
            => WriteEvent(3, category ?? "", debugMessage ?? "", file ?? "", member ?? "", line);

        [T.Event(4, Level = EventLevel.Critical)]
        public void Critical(string category, string debugMessage, [CallerFilePath] string file = null, [CallerMemberName] string member = null, [CallerLineNumber] int line = 0)
            => WriteEvent(4, category ?? "", debugMessage ?? "", file ?? "", member ?? "", line);
